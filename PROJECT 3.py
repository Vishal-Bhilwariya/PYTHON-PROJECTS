#PYHTON ASSIGNMENT GIVEN BY MAYANK SAXENA SIR JI 

# //Write a python program that implements the inventory management system using dictionaries. 
...
lst = []     # we will store the roll number which we will delete..
